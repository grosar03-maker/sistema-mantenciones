...
from infrastructure.views.mecanico_views import (
    ...
    eliminar_cliente, eliminar_clientes_masivo, eliminar_modelos_masivo,
...
urlpatterns = [
    ...
    path("mecanico/modelos/eliminar-masivo/", eliminar_modelos_masivo, name="eliminar_modelos_masivo"),
